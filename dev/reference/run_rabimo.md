...
- data:
  ...
  [`rabimo_inputs_2025`](https://kwb-r.github.io/kwb.rabimo/dev/reference/rabimo_inputs_2025.md)`$data`

- config:

  configuration object (list) similar to
  [`rabimo_inputs_2025`](https://kwb-r.github.io/kwb.rabimo/dev/reference/rabimo_inputs_2025.md)`$config`
